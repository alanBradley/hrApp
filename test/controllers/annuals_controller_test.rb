...
class AnnualsControllerTest < ActionController::TestCase
  ...
  test "should create annual" do
    assert_difference('Annual.count') do
      post :create, annual: { date: @annual.date, description: @annual.description, employee_id: @annual.employee_id }
    end
  ...
  test "should update annual" do
    patch :update, id: @annual, annual: { date: @annual.date, description: @annual.description, employee_id: @annual.employee_id }
    assert_redirected_to annual_path(assigns(:annual))
  end
